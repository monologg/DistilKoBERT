...
def sanity_checks(args):
    ...
    if args.mlm:
        ...
        assert (args.student_type in ['roberta', 'distilkobert', 'distilbert']) and (args.teacher_type in ['roberta', 'kobert', 'bert'])
    else:
...
def main():
    ...
    parser.add_argument("--student_type", type=str, choices=["distilbert", "roberta", "gpt2", "distilkobert"], required=True,
                        help="The student type (DistilKoBERT, DistilBERT, RoBERTa).")
    ...
    parser.add_argument("--teacher_type", choices=["bert", "roberta", "gpt2", "kobert"], required=True,
                        help="Teacher type (KoBERT, BERT, RoBERTa).")
